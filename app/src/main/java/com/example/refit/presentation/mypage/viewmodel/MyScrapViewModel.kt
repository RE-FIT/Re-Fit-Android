...
class MyScrapViewModel(private val repository: MyPageRepository) : ViewModel() {

    private val _scrapList: MutableLiveData<List<CommunityListItemResponse>> = MutableLiveData<List<CommunityListItemResponse>>()
    val scrapList: LiveData<List<CommunityListItemResponse>>
        get() = _scrapList

    fun getCommunityList() {
        try {
            _scrapList.value = listOf(
